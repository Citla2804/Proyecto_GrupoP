...
public class Game {
    ...
    public void startGame() {
        ...
        while (playing) {
            ...
            if (!player.isAlive()) {
                ...
                String response = scanner.nextLine();
                if (response.equalsIgnoreCase("si")) {
                    player.getInventory().showInventory();  // Mostrar el inventario del jugador
                }
            }
        }
    }
    ...
    private Enemy generateRandomEnemy() {
        return Randomize.getRandomEnemy();  // Implementa la lógica para generar enemigos aleatorios
    }
}
